...
(p "You can browse the "
   (a (@ (href "http://git.savannah.nongnu.org/gitweb/?p=serdes.git"))
      "Git repository")
...
(pre (@ class "terminal")
     ...
     " clone git://git.savannah.nongnu.org/serdes.git")
...
(p "If you have time and programming skills, you can help us by developing "
   ...
   "Subscribe to the "
   (a (@ (href "http://lists.nongnu.org/mailman/listinfo/serdes-generic"))
      "mailing list")
